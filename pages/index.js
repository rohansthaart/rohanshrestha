...
const capabilityAreas = [
  {
    ...
    text: 'I build frontend systems with clear hierarchy, cleaner states, and enough visual discipline to feel trustworthy on first use.'
  },
  {
    title: 'Full-stack ownership when projects get messy',
    text: 'I am comfortable moving between UI, backend-connected logic, debugging, deployment, and production support when delivery depends on it.'
  },
  {
    title: 'Design sensitivity without the handoff gap',
    text: 'I can translate brand and visual direction into real screens, assets, and implementation details without losing the original intent.'
  }
]
...
const proofStats = [
  ...
  {
    value: `${primaryProjects.length}+`,
    label: 'major projects documented here'
  },
  {
    value: `${graphicsProjects.length}+`,
    label: 'supporting brand and graphic deliverables'
  }
]
    ...
    <Layout>
      <Stack spacing={{ base: 14, md: 18 }}>
            ...
            <GridItem>
              <Stack spacing={5}>
                ...
                <Text
                  ...
                  maxW="24ch"
                >
                  I help teams ship products that are technically dependable,
                  visually clear, and ready for real users.
                </Text>
                <Text maxW="62ch" color="muted">
                  Based in Kathmandu, I work across product UI, frontend
                  engineering, backend-connected delivery, and supporting visual
                  systems. The best fit is usually teams who want one person
                  that can carry both execution and polish.
                </Text>
                  ...
                  <AspectRatio ratio={4 / 5}>
                    <Box position="relative" w="100%" h="100%">
                      <NextImage
                        ...
                        priority
                        placeholder="blur"
                        sizes="(max-width: 30em) 100vw, (max-width: 48em) 58vw, 32vw"
                      ...
                      <AspectRatio ratio={16 / 10}>
                        <Box position="relative" w="100%" h="100%">
                          <NextImage
                            ...
                            priority={index === 0}
                            placeholder="blur"
                            sizes="(max-width: 30em) 100vw, (max-width: 48em) 52vw, 18vw"
                            style={{ objectFit: 'cover' }}
                          />
                        </Box>
                      </AspectRatio>
        ...
        <Section delay={0.08} mb={0}>
          <Stack spacing={6} pt={4} borderTopWidth="1px" borderColor="line">
            <Grid
            ...
            >
              <Grid
                templateColumns={{
                  base: '1fr',
                  lg: 'minmax(0, 280px) minmax(0, 1fr)'
                }}
                gap={{ base: 8, lg: 10 }}
                alignItems="start"
              >
                <Stack spacing={4}>
                  ...
                  <Text color="muted" maxW="30ch">
                    The tools below are the ones I would be happy to reach for
                    again on real product work, not every library I have touched
                    once.
                  </Text>
                </Stack>
                ...
                <Box>
                  ...
                  <Text
                    ...
                    borderColor="line"
                  >
                    Also comfortable with Git, REST API integration, Vite, Jest,
                    MongoDB, and AWS EC2 when a project needs them.
                  </Text>
                </Box>
              </Grid>
            </Box>
        ...
        <Section delay={0.12} mb={0}>
          ...
          >
            <GridItem>
              ...
              <Text color="muted">
                These are the projects that best represent the overlap between
                product thinking, implementation quality, and real-world
                delivery pressure.
              </Text>
            </GridItem>
                      ...
                      <AspectRatio ratio={4 / 3}>
                        ...
                        >
                          <NextImage
                            ...
                            fill
                            placeholder="blur"
                            sizes="(max-width: 48em) 100vw, 220px"
              ...
              <SimpleGrid columns={{ base: 1, md: 2 }} spacing={6}>
                ...
                >
                  ...
                  <Text
                    ...
                    mb={2}
                  >
                    {graphicsProjects.length}+ brand, social, print, and
                    campaign assets
                  </Text>
                  <Text color="muted" mb={4}>
                    Supporting visual systems that help products and brands feel
                    more coherent in the real world.
                  </Text>
                  <Button
                    as={NextLink}
                    href="/graphics"
                ...
                >
                  ...
                  <Text
                    ...
                    mb={2}
                  >
                    {artCollections.length} personal collections rooted in
                    observation and craft
                  </Text>
                  <Text color="muted" mb={4}>
                    A quieter practice that keeps my sense of composition,
                    detail, and mood from becoming purely technical.
                  </Text>
                  <Button
                    as={NextLink}
                    href="/arts"
            ...
            >
              <Box>
                ...
                <Text color="muted" maxW="58ch">
                  I am open to freelance, contract, and full-time roles where I
                  can contribute across interface quality, frontend execution,
                  backend-connected delivery, and launch support.
                </Text>
              </Box>
              <Stack spacing={3}>
                <Button
